...
export interface HttpInterceptorManager<V, E = V> {
  use(onFulfilled?: (config: V) => API | Promise<API> | V, onRejected?: (config: E) => Promise<E> | E): void;
...
export type InterceptorsResponse = HttpInterceptorManager<HttpSuccess<API>, HttpError>;
