		...
		<view :class="[direction==='column'?'uni-steps__column':'uni-steps__row']">
			...
			<view :class="[direction==='column'?'uni-steps__column-container':'uni-steps__row-container']">
				<view :class="[direction==='column'?'uni-steps__column-line-item':'uni-steps__row-line-item']"
					...
					<view :class="[direction==='column'?'uni-steps__column-check uni-steps__column-circle':'uni-steps__row-circle uni-steps__row-check']"
						v-if="index === active" :style="{backgroundColor:activeColor}">
					</view>
					<view v-if="index > active" :class="[direction==='column'?'uni-steps__column-circle':'uni-steps__row-circle']" :style="{ backgroundColor: index < active ? '' : deactiveColor}"></view>
					<uni-icons class="icons" v-if="index < active" :color="activeColor" :type="activeIcon" size="14"></uni-icons>
					<view
