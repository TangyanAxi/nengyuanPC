<script setup lang="ts">
  ...
  const goDetial = (index: any) => {
    ...
    uni.navigateTo({
      url: '/pages/knowledge/fixExper/detail?data=' + JSON.stringify(data),
    });
  };
      ...
      <view class="uno-w-full uno-my-20rpx uno-px-32rpx uno-pt-1rpx uno-pb-10rpx uno-bg-white">
        ...
        >
          <view class="uno-flex uno-items-center uno-justify-between">
            ...
            <view class="uno-px-10rpx uno-py-6rpx uno-bg-[#DEFCFF] uno-c-[#42BBC9] uno-text-24rpx flex-center">维修经验库</view>
          </view>
